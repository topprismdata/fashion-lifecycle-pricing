"""
H&M R19: Full GBDT Pipeline — Multi-fold Training + Rich Features

R18 scored 0.02318 (first GBDT attempt) but was limited by:
  - Only 40K training users
  - 1:160 pos:neg ratio (no negative sampling)
  - 22 features (1st place used ~500)
  - No cross-validation

R19 improvements:
  1. Multi-fold temporal training (weeks 1, 2, 3 as targets)
  2. Proper negative sampling (1:4 pos:neg)
  3. 40+ features (recall scores, time, counts, aggregation)
  4. ~80 candidates per user
  5. No data leakage features
"""
import pandas as pd
import numpy as np
...
print("=" * 60)
print("R19: Full GBDT Pipeline v2")
print("=" * 60)
...
sub_path = OUTPUTS / "submission_r19_gbdt_v2.csv"
...
print("R19 Complete")
print(f"Val MAP@12 (active): {map12_active:.6f}")
print(f"R17: 0.02282 (heuristic) | R18: 0.02318 (GBDT v1)")
print("=" * 60)
