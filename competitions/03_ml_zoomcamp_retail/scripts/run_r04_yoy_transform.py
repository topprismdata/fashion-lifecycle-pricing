#!/usr/bin/env python3
"""
R04 YoY + Target Transform: Extends R03 Multi-Source Features.
...
SUBMISSION_PATH = OUTPUT_DIR / "submission_r04_yoy_transform.csv"
...
def main() -> float:
    log("=" * 70)
    log("R04 YoY + Target Transform: CatBoost + YoY Features + log1p")
    log("=" * 70)
    ...
    log("=" * 70)
    log("R04 YoY + Target Transform Summary")
    log("=" * 70)
